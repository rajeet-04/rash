        ...
        >
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div variants={itemVariants} className="space-y-6">
              ...
              >
                <h3 className="text-2xl font-departure font-semibold mb-4 text-primary-600 dark:text-primary-400">
                  Creative Innovator
                </h3>
          ...
          >
            {[
              ...
              >
                <motion.div
                  className="text-3xl md:text-4xl font-space font-bold text-primary-400 mb-2"
                  initial={{ scale: 0 }}
                  whileInView={{ scale: 1 }}
                ...
                <div className="text-text-tertiary text-sm font-space">{stat.label}</div>
              </motion.div>
            ))}
          </motion.div>
        </motion.div>
