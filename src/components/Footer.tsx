    ...
    <footer className="relative py-16 px-6 bg-gradient-to-br from-slate-100 to-blue-50 dark:from-dark-950 dark:to-dark-900 border-t border-slate-300 dark:border-secondary-800">
        ...
        >
          <div className="text-center font-mono text-xs leading-tight">
            ...
            >
              ...
              <span>•</span>
              <span className="flex items-center gap-2">
                Built with <HeartIcon className="w-4 h-4 text-red-500 fill-current" />
              </span>
              <span>•</span>
              <span className="flex items-center gap-2">
                ...
                Status: 
                <motion.span
                  className="ml-1 text-green-500 dark:text-green-400 font-medium"
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                'Python', 'TailwindCSS', 'Framer Motion'
              ].map((tech) => (
                <span
                  key={tech}
      ...
      <div className="absolute inset-0 opacity-[0.02] dark:opacity-[0.05] pointer-events-none">
        <div className="absolute inset-0" style={{
          backgroundImage: `
            linear-gradient(90deg, rgb(var(--color-accent)) 1px, transparent 1px),
            linear-gradient(180deg, rgb(var(--color-accent)) 1px, transparent 1px)
          `,
